...
class URLTest extends \PHPUnit\Framework\TestCase {
     ...
     * @param string @expectedResult What we expect our slug result
     *
     * @dataProvider providerTestSluggifyReturnsSluggfiedString
    **/
  ...
  public function providerTestSluggifyReturnsSluggfiedString() {
    return array(
